...
<div class="border-b border-gray-200 dark:border-gray-700">
    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
        ...
        <li class="me-2">
            <a href="#" class="inline-flex items-center justify-center p-4 text-blue-600 border-b-2 dark:border-purple-600 rounded-t-lg active dark:text-blue-500 dark:border-purple-600 group" aria-current="page">
                <svg class="w-4 h-4 me-2 text-black-600 dark:text-black-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
  ...
  <footer class="bg-gray-300 text-black py-4 dark:border-purple-600">
