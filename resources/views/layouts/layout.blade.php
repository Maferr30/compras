...
<body class="min-h-screen flex flex-col">
 ...
 <div class=" bg-gray-200 border-b border-rose-400">
        ...
        <div class="flex items-center ml-8 mr-8">
            ...
            <li class="me-2">
                <a href="{{ route('proveedor') }}" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-rose-300 group">
            ...
            <li class="me-2">
            <a href="{{ route('ordencompra') }}" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-rose-300 group">
            ...
            <li class="me-2">
                <a href="{{ route('recepcion') }}" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-rose-300 group">
            ...
            <li class="me-2">
                <a href="{{ route('devolucion') }}" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-rose-300 group">
            ...
            <li class="me-2">
                <a href="{{ route('empleados') }}" class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-rose-300 group">
