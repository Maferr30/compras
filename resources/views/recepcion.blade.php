                    ...
                    <tr class="bg-white border-b">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-2">
                               <!-- Botón Eliminar -->
                               <form action="{{ route('recepcion.destroyByCompraId', $item->idOrden_compra) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                 <button type="submit" class="flex items-center text-red-600 hover:underline mr-4"
                                 onclick="return confirm('¿Estás seguro de que quieres eliminar esta recepcion?');">
