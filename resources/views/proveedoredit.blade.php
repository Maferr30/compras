                ...
                <div class="grid gap-4 px-18 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <div class="relative">
                                <input type="text" name="nombre_empresa" id="nombre_empresa"
                                    ...
                                    value="{{ old('nombre_empresa', $proveedor->nombre_empresa) }}" placeholder="Empresas Polar" required>
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                                            d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a1 1 0 110 2h-3a1 1 0 01-1-1v-2a1 1 0 00-1-1H9a1 1 0 00-1 1v2a1 1 0 01-1 1H4a2 2 0 01-2-2V4zm3 1h2v2H7V5zm2 4H7v2h2V9zm2-4h2v2h-2V5zm2 4h-2v2h2V9z"
                        ...
                        <div class="w-full">
                            ...
                            <div class="relative">
                                <input type="text" name="direccion_empresa" id="direccion_empresa"
                                    class="bg-white border border-rose-200 text-black-900 text-sm rounded-lg focus:ring-primary-600 focus:border-rose-300 block w-full pl-10 p-2.5 hover:border-rose-300"
                                    value="{{ old('direccion_empresa', $proveedor->direccion_empresa) }}" placeholder="Altamira" required>
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                    ...
                    <div class="sm:col-span-2 flex space-x-4">
                        <div class="w-full">
                            ...
                            <div class="relative">
                                <input type="text" name="telefono_proveedor" id="telefono_proveedor"
                                    class="bg-white border border-rose-200 text-black-900 text-sm rounded-lg focus:ring-primary-600 focus:border-rose-300 block w-full pl-10 p-2.5 hover:border-rose-300"
                                    value="{{ old('telefono_proveedor', $proveedor->telefono_proveedor) }}" placeholder="0412-000000" required>
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="rif" id="rif"
                                ...
                                value="{{ old('rif', $proveedor->rif) }}" placeholder="J-12345678-1" required>
                            @error('rif')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="w-full">
                        ...
                        <input type="email" name="correo_proveedor" id="correo_proveedor"
                            class="bg-white border border-rose-200 text-black-900 text-sm rounded-lg focus:ring-primary-600 focus:border-rose-300 block w-full p-2.5 hover:border-rose-300"
                            value="{{ old('correo_proveedor', $proveedor->correo_proveedor) }}" placeholder="example@domain.com" required>
                    ...
                    <div>
                        ...
                        <select id="categorias"
                            value="{{ old('rif', $proveedor->categorias) }}"
                            name="categorias[]" class="bg-white border border-rose-200 text-black-900 text-sm rounded-lg focus:ring-primary-600 focus:border-rose-300 block w-full p-2.5 hover:border-rose-300">
