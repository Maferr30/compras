            ...
            <form action="#">
                <div class="grid gap-4 px-18  sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2 flex space-x-4">
                        <div class="w-full">
                            <label for="empleado"
                                class="block mb-2 text-sm font-medium text-gray-900">Empleado</label>
                            <div class="relative">
                                <input type="text" name="empleado" id="Empleados_idEmpleados"
                                    ...
                                    placeholder="Maria Fernanda" required>
                                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-gray-500"
                                        viewBox="0 0 20 20" fill="currentColor">
                                        <path
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="proveedor" id="Proveedores_idProveedores"
